...
static const ModRec MODS[] = {
    ...
    { 0x0303, "◌̃",  "nas",       TIER_NASAL,     -1, mod_nasal,        0, {0,0} , NULL },
    { 0x0304, "◌̄",  "macron_tone", TIER_COUNT,    -1, NULL, 0, {0,0} , NULL },
    { 0x0324, "◌̤",  "breathy",   TIER_LARYNGEAL, -1, mod_breathy,      0, {0,0} , NULL },
    { 0x0306, "◌̆",  "short",     TIER_TIMING,    -1, mod_extra_short,  0, {0,0} , NULL },
    { 0x0308, "◌̈",  "centralized", TIER_MANNER,  -1, mod_centralized,  0, {0,0} , NULL },
    { 0x030A, "◌̊",  "vl",        TIER_LARYNGEAL, -1, mod_voiceless,    0, {0,0} , NULL },
    { 0x030B, "◌̋",  "extra_high_tone", TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x031A, "◌̚",  "unrel",     TIER_TIMING,    -1, mod_unrel,        0, {0,0} , NULL },
    { 0x031C, "◌̜",  "rnd_less",  TIER_PLACE,     -1, mod_less_round,   0, {0,0} , NULL },
    { 0x031D, "◌̝",  "raised",    TIER_MANNER,    -1, mod_raised,       0, {0,0} , NULL },
    { 0x031E, "◌̞",  "lowered",   TIER_MANNER,    -1, mod_lowered,      0, {0,0} , NULL },
    { 0x031F, "◌̟",  "adv",       TIER_PLACE,     -1, mod_advanced,     0, {0,0} , NULL },
    { 0x0320, "◌̠",  "retr",      TIER_PLACE,     -1, mod_retracted,    0, {0,0} , NULL },
    { 0x0318, "◌̘",  "atr",       TIER_PLACE,     -1, mod_atr,          0, {0,0} , NULL },
    { 0x0319, "◌̙",  "rtr",       TIER_PLACE,     -1, mod_rtr,          0, {0,0} , NULL },
    { 0x0322, "◌̢",  "retroflex", TIER_PLACE,     -1, mod_retracted,    0, {0,0} , NULL },
    { 0x0321, "◌̡",  "pal_hook",  TIER_PLACE,     -1, mod_pal_hook,     0, {0,0} , NULL },
    { 0x032B, "◌̫",  "lab_subw",  TIER_PLACE,     -1, mod_lab_subw,     0, {0,0} , NULL },
    { 0x0316, "◌̖",  "tone_lowfall", TIER_COUNT,  -1, NULL, 0, {0,0} , NULL },
    { 0x0317, "◌̗",  "tone_lowrise", TIER_COUNT,  -1, NULL, 0, {0,0} , NULL },
    /* IPA 2018: fortis / lenis */
    { 0x0348, "◌͈",  "fortis",    TIER_LARYNGEAL, -1, mod_fortis,      0, {0,0} , NULL },
    { 0x0349, "◌͉",  "lenis",     TIER_LARYNGEAL, -1, mod_lenis,       0, {0,0} , NULL },
    /* extIPA diacritics */
    { 0x0347, "◌͇",  "alveolar",  TIER_PLACE,     -1, mod_alveolar_mark, 0, {0,0} , NULL },
    { 0x034E, "◌͎",  "whistled",  TIER_MANNER,    -1, mod_whistled,    0, {0,0} , NULL },
    { 0x1DB9, "◌ᶹ",  "labiodental", TIER_PLACE,   -1, mod_lbd_mark,    0, {0,0} , NULL },
    { 0x0362, "◌͢",  "sliding",   TIER_TIMING,    -1, mod_sliding,     0, {0,0} , NULL },
    { 0x0323, "◌̣",  "lowered",   TIER_MANNER,    -1, mod_lowered,      0, {0,0} , NULL },
    { 0x0325, "◌̥",  "vl",        TIER_LARYNGEAL, -1, mod_voiceless,    0, {0,0} , NULL },
    { 0x0329, "◌̩",  "syl",       TIER_TIMING,    -1, mod_syl,          0, {0,0} , NULL },
    { 0x032A, "◌̪",  "dental",    TIER_PLACE,     -1, mod_dental,       0, {0,0} , NULL },
    { 0x032C, "◌̬",  "vd",        TIER_LARYNGEAL, -1, mod_voiced,       0, {0,0} , NULL },
    { 0x032F, "◌̯",  "nsyl",      TIER_TIMING,    -1, mod_nosyl,        0, {0,0} , NULL },
    { 0x0330, "◌̰",  "creaky",    TIER_LARYNGEAL, -1, mod_creaky,       0, {0,0} , NULL },
    { 0x0334, "◌̴",  "phar",      TIER_PLACE,     -1, mod_phar,         0, {0,0} , NULL },
    { 0x0339, "◌̹",  "rnd_more",  TIER_PLACE,     -1, mod_more_round,   0, {0,0} , NULL },
    { 0x033A, "◌̺",  "apical",    TIER_MANNER,    -1, mod_apical,       0, {0,0} , NULL },
    { 0x033B, "◌̻",  "laminal",   TIER_MANNER,    -1, mod_laminal,      0, {0,0} , NULL },
    { 0x033C, "◌̼",  "linguolabial", TIER_PLACE,  -1, mod_linguolabial, 0, {0,0} , NULL },
    { 0x033D, "◌̽",  "midcent",   TIER_MANNER,    -1, mod_midcent,      0, {0,0} , NULL },
    { 0x0346, "◌͆",  "lam",       TIER_MANNER,    -1, mod_laminal,      0, {0,0} , NULL },
    /* pitch/tone diacritics — no articulatory effect */
    { 0x0300, "◌̀",  "tone_low",      TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x0301, "◌́",  "tone_high",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x0302, "◌̂",  "tone_fall",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x030C, "◌̌",  "tone_rise",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x030F, "◌̏",  "tone_extralow",TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x030D, "◌̍",  "tone_highv",   TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x030E, "◌̎",  "tone_lowv",    TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    /* --- ligature ties (no apply; handled by parser) --- */
    { 0x035C, "◌͜",  "tie",       TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    { 0x0360, "◌͠",  "tie",       TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    { 0x0361, "◌͡",  "tie",       TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    /* --- postposed spacing modifier letters --- */
    { 0x02B0, "ʰ",   "asp",       TIER_LARYNGEAL, -1, mod_asp,          0, {0,0} , NULL },
    { 0x02B2, "ʲ",   "pal",       TIER_PLACE,     -1, mod_pal,         0, {0,0} , NULL },
    { 0x02B7, "ʷ",   "lab",       TIER_PLACE,     -1, mod_lab,         0, {0,0} , NULL },
    { 0x02BC, "ʼ",   "ej",        TIER_AIRSTREAM, 1,  mod_ejective,    0, {0,0} , NULL },
    { 0x02BD, "ʽ",   "weak_asp",  TIER_LARYNGEAL, -1, mod_weak_asp,    0, {0,0} , "quote ʽ reinterpreted as weak aspiration" },
    { 0x2018, "‘",   "weak_asp",  TIER_LARYNGEAL, -1, mod_weak_asp,    0, {0,0} , "quote ‘ reinterpreted as weak aspiration" },
    { 0x201B, "‛",   "weak_asp",  TIER_LARYNGEAL, -1, mod_weak_asp,    0, {0,0} , "quote ‛ reinterpreted as weak aspiration" },
    { 0x2032, "′",   "pal_prime", TIER_PLACE,     -1, mod_pal,         0, {0,0} , "prime ′ reinterpreted as palatalization (Irish tradition)" },
    { 0x0027, "'",   "unrel",     TIER_TIMING,    -1, mod_unrel,       0, {0,0} , "ASCII apostrophe ' reinterpreted as unreleased release" },
    { 0x02C0, "ˀ",   "glottal_onset", TIER_AIRSTREAM, -1, mod_glottal_onset, 0, {0,0} , NULL },
    { 0x02C8, "ˈ",   "stress_1",  TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    { 0x02CC, "ˌ",   "stress_2",  TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    { 0x02D0, "ː",   "long",      TIER_TIMING,    -1, mod_long,        0, {0,0} , NULL },
    { 0x02D1, "ˑ",   "half",      TIER_TIMING,    -1, mod_half,        0, {0,0} , NULL },
    { 0x02D4, "˔",   "raised",    TIER_MANNER,    -1, mod_raised,      0, {0,0} , NULL },
    { 0x02D5, "˕",   "lowered",   TIER_MANNER,    -1, mod_lowered,     0, {0,0} , NULL },
    { 0x02DE, "˞",   "rhot",      TIER_MANNER,    -1, mod_rhot,        0, {0,0} , NULL },
    { 0x02E0, "ˠ",   "vel",       TIER_PLACE,     -1, mod_velar,       0, {0,0} , NULL },
    { 0x02E1, "ˡ",   "lat_release", TIER_MANNER,  -1, mod_lat_release, 0, {0,0} , NULL },
    { 0x02E2, "ˢ",   "fric_release", TIER_MANNER, -1, mod_fric_release,0, {0,0} , NULL },
    { 0x02E4, "ˤ",   "phar",      TIER_PLACE,     -1, mod_phar,        0, {0,0} , NULL },
    /* superscript letters as diacritics (IPA letters used as modifiers) */
    { 0x02B3, "ʳ",   "sup_rhot_r",   TIER_MANNER, -1, mod_sup_rhot1,   0, {0,0} , NULL },
    { 0x02B4, "ʴ",   "sup_rhot_ʁ",   TIER_MANNER, -1, mod_sup_rhot1,   0, {0,0} , NULL },
    { 0x02B5, "ʵ",   "sup_rhot_ʕ",   TIER_MANNER, -1, mod_sup_rhot1,   0, {0,0} , NULL },
    { 0x02B6, "ʶ",   "sup_rhot_ʢ",   TIER_MANNER, -1, mod_sup_rhot1,   0, {0,0} , NULL },
    { 0x1D49, "ᵉ",   "sup_e",        TIER_PLACE,  -1, mod_sup_front,   0, {0,0} , NULL },
    { 0x1D4C, "ᵌ",   "sup_ɛ",        TIER_MANNER, -1, mod_sup_mid,     0, {0,0} , NULL },
    { 0x1D64, "ᵤ",   "sup_u",        TIER_PLACE,  -1, mod_sup_back,    0, {0,0} , NULL },
    { 0x1D62, "ᵢ",   "sub_i",        TIER_PLACE,  -1, mod_sup_front,   0, {0,0} , NULL },
    { 0x1D63, "ᵣ",   "sub_r",        TIER_MANNER, -1, mod_sup_rhot1,   0, {0,0} , NULL },
    { 0x1D30, "ᴰ",   "sup_h",        TIER_LARYNGEAL, -1, mod_asp,       0, {0,0} , NULL },
    { 0x1D3B, "ᴻ",   "sup_N",        TIER_NASAL,  -1, mod_nasal_rel,   0, {0,0} , NULL },
    { 0x1D2C, "ᴬ",   "sup_A",        TIER_NASAL,  -1, mod_sup_open,    0, {0,0} , NULL },
    { 0x1D2E, "ᴮ",   "sup_B",        TIER_MANNER, -1, mod_sup_stop,    0, {0,0} , NULL },
    { 0x1D3C, "ᴼ",   "sup_O",        TIER_PLACE,  -1, mod_sup_back,    0, {0,0} , NULL },
    { 0x1D3E, "ᴾ",   "sup_P",        TIER_MANNER, -1, mod_sup_stop,    0, {0,0} , NULL },
    { 0x1D41, "ᵁ",   "sup_U",        TIER_PLACE,  -1, mod_sup_back,    0, {0,0} , NULL },
    { 0x1D42, "ᵂ",   "sup_W",        TIER_PLACE,  -1, mod_lab,         0, {0,0} , NULL },
    { 0x02D2, "˒",   "light",        TIER_TIMING, -1, mod_sliding,     0, {0,0} , NULL },
    { 0x02D3, "˓",   "dark",         TIER_TIMING, -1, mod_sliding,     0, {0,0} , NULL },
    { 0x02D9, "˙",   "lengthened",   TIER_TIMING, -1, mod_long,        0, {0,0} , NULL },
    /* --- preposed modifiers --- */
    { 0x1D51, "ᵑ",   "nas_click", TIER_AIRSTREAM, -1, mod_nasal_click, 0, {0,0} , NULL },
    { 0x1D4B, "ᵋ",   "nas_rel",   TIER_AIRSTREAM, -1, mod_nasal,       0, {0,0} , NULL },
    { 0x1D4A, "ᵊ",   "schwa_rel", TIER_MANNER,    -1, mod_schwa_rel,   0, {0,0} , NULL },
    { 0x207F, "ⁿ",   "nasal_rel", TIER_NASAL,     -1, mod_nasal_rel,   0, {0,0} , NULL },
    { 0x02B1, "ʱ",   "breathy_asp", TIER_LARYNGEAL, -1, mod_breathy_asp, 0, {0,0} , "ʱ = voiced/breathy release (reinterpreted from aspiration)" },
    { 0x02B8, "ʸ",   "offglide_pal", TIER_PLACE,  -1, mod_offglide_pal,0, {0,0} , NULL },
    { 0x1DB7, "ᶷ",   "offglide_lab", TIER_PLACE,  -1, mod_offglide_lab,0, {0,0} , NULL },
    { 0x1DA3, "ᶣ",   "offglide_labpal", TIER_PLACE, -1, mod_offglide_pal, 0, {0,0} , NULL },
    /* --- 5-level tone letters (high->low) --- */
    { 0x02E5, "˥", "tone_5",  TIER_COUNT, -1, NULL, 1, {5,0}, NULL },
    { 0x02E6, "˦", "tone_4",  TIER_COUNT, -1, NULL, 1, {4,0}, NULL },
    { 0x02E7, "˧", "tone_3",  TIER_COUNT, -1, NULL, 1, {3,0}, NULL },
    { 0x02E8, "˨", "tone_2",  TIER_COUNT, -1, NULL, 1, {2,0}, NULL },
    { 0x02E9, "˩", "tone_1",  TIER_COUNT, -1, NULL, 1, {1,0}, NULL },
    { 0xA712, "꜒", "tone_5",  TIER_COUNT, -1, NULL, 1, {5,0}, NULL },
    { 0xA713, "꜓", "tone_4",  TIER_COUNT, -1, NULL, 1, {4,0}, NULL },
    { 0xA714, "꜔", "tone_3",  TIER_COUNT, -1, NULL, 1, {3,0}, NULL },
    { 0xA715, "꜕", "tone_2",  TIER_COUNT, -1, NULL, 1, {2,0}, NULL },
    { 0xA716, "꜖", "tone_1",  TIER_COUNT, -1, NULL, 1, {1,0}, NULL },
    /* --- Chinese tone classes 1..8 -> 1,-1,2,-2,3,-3,4,-4 --- */
    { 0xA700, "꜀", "class1",  TIER_COUNT, -1, NULL, 2, {1, 0}, NULL },
    { 0xA701, "꜁", "class2",  TIER_COUNT, -1, NULL, 2, {-1,0}, NULL },
    { 0xA702, "꜂", "class3",  TIER_COUNT, -1, NULL, 2, {2, 0}, NULL },
    { 0xA703, "꜃", "class4",  TIER_COUNT, -1, NULL, 2, {-2,0}, NULL },
    { 0xA704, "꜄", "class5",  TIER_COUNT, -1, NULL, 2, {3, 0}, NULL },
    { 0xA705, "꜅", "class6",  TIER_COUNT, -1, NULL, 2, {-3,0}, NULL },
    { 0xA706, "꜆", "class7",  TIER_COUNT, -1, NULL, 2, {4, 0}, NULL },
    { 0xA707, "꜇", "class8",  TIER_COUNT, -1, NULL, 2, {-4,0}, NULL },
    /* --- upstep / downstep / global rise / global fall --- */
    { 0xA71B, "ꜛ", "upstep",   TIER_COUNT, -1, NULL, 3, {-1, NAN}, NULL },
    { 0xA71C, "ꜜ", "downstep", TIER_COUNT, -1, NULL, 3, {1,  NAN}, NULL },
    { 0x2197, "↗", "global_up",   TIER_COUNT, -1, NULL, 4, {NAN, 1}, NULL },
    { 0x2198, "↘", "global_down", TIER_COUNT, -1, NULL, 4, {NAN, -1}, NULL },
    /* --- pitch contour marks (diacritics) — no articulatory effect --- */
    { 0x1DC4, "◌᷄", "pitch_midrise",  TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x1DC5, "◌᷅", "pitch_midfall",  TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x1DC6, "◌᷆", "pitch_highfall", TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x1DC7, "◌᷇", "pitch_highrise", TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x1DC8, "◌᷈", "pitch_risefall", TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x1DC9, "◌᷉", "pitch_fallrise", TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    /* --- undertie (linking) — ignored --- */
    { 0x203F, "‿",   "link",     TIER_COUNT,     -1, NULL, 0, {0,0} , NULL },
    /* --- superscript digits (pitch levels, e.g. ⁵²); ignored --- */
    { 0x2070, "⁰", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x00B9, "¹", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x00B2, "²", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x00B3, "³", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2074, "⁴", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2075, "⁵", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2076, "⁶", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2077, "⁷", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2078, "⁸", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
    { 0x2079, "⁹", "pitch",     TIER_COUNT, -1, NULL, 0, {0,0} , NULL },
};
